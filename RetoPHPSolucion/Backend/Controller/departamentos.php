...
switch ($_GET['op']){
    ...
    case "insert":
        ...
        $datos=$accionCamper->insert_camper($body["id"], $body["nombre"], $body["pais"]);
    ...
    case "delete":
        ...
        echo json_encode($datos);
        header("Location: http://localhost/PruebaPHP/retoPHPV2/RetoPHPSolucion/Frontend/departamento")
        break;
